...
function resetBtn_Click()
{
	...
	if (document.getElementById('user_data_7').value == "STORAGE") {
...
function initPage()
{
	...
	*/
	...
	if (document.getElementById('user_data_7').value == "STORAGE") {
		...
		if ( document.getElementById('radio2RB').checked )					// Credit
		{
			document.getElementById('ccGroupDiv').style.display='inline';
			document.getElementById('achGroupDiv').style.display='none';
		}
		else if ( document.getElementById('radio4RB').checked )				// Debit
		{
			document.getElementById('ccGroupDiv').style.display='inline';
			document.getElementById('achGroupDiv').style.display='none';
		}
		else if ( document.getElementById('radio5RB').checked )				// ACH
		{
...
function onSubmit()
{
	...
	*/	
	//	document.getElementById('amount').disabled = true;
		...
		document.getElementById('tran_code').value = 'AUTH'; //TRAN_GROUP == "AUTH"
	}
