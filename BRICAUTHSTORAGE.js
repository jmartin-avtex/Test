...
//# sourceMappingURL=EPX_BRICAUTH.js.map
...
(function (BRICREFUND) {
    ...
    BRICREFUND.Functions = Functions;
})(BRICREFUND || (BRICREFUND = {}));
//# sourceMappingURL=EPX_BRICREFUND.js.map
...
function resetBtn_Click() {
    ...
    } else if (document.getElementById("user_data_7").value == "REFUND") {
        BRICREFUND.Functions.prototype.resetBtn_Click();
    }
}
...
function initPage() {
    ...
    if (document.getElementById("user_data_7").value == "STORAGE" || document.getElementById("user_data_7").value == "ACHSTORAGE") {
        ...
        BRICREFUND.Functions.prototype.initStyling();
        BRICREFUND.Functions.prototype.initPage();
    }
}
